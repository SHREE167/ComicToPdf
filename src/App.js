...
function App() {
   ...
   const backendUrl = "https://comictopdf-production.up.railway.app"; // ✅ Base backend URL
...
const fetchChapters = async () => {
    ...
    try {
        setLoading(true);
        const response = await fetch(`${backendUrl}/get-chapters`, {  // ✅ Correct API endpoint
            method: "POST",
...
const handleDownload = async (e) => {
    ...
    try {
        setLoading(true);
        const response = await fetch(`${backendUrl}/scrape-comic`, {  // ✅ Correct API endpoint
            method: "POST",
            headers: { "Content-Type": "application/json" },
